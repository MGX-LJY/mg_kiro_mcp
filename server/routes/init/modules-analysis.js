...
export function createModulesAnalysisRoutes(services) {
    ...
    router.post('/analyze-modules', async (req, res) => {
        try {
            ...
            console.log(`[ModulesAnalysis] 深度模块分析完成 (AI驱动): ${executionTime}ms，分析了 ${moduleAnalysis.modules.length} 个模块`);
            console.log(`[ModulesAnalysis] - 模式: AI智能分析 + 模块文档`);
            console.log(`[ModulesAnalysis] - 令牌优化: 预计45-50%消耗`);
            console.log(`[ModulesAnalysis] - AI模板: module-analysis.md`);
